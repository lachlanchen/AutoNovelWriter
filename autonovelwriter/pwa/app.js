(function () {
  ...
  const I18N = {
    en: {
      ...
      'pipeline.delete_title': 'Delete selected block (Del/Backspace)',
    ...
    'zh-Hans': {
      ...
      'pipeline.delete': '删除',
      'pipeline.delete_title': '删除选中块（Del/Backspace）',
    ...
    'zh-Hant': {
      ...
      'pipeline.delete': '刪除',
      'pipeline.delete_title': '刪除所選區塊（Del/Backspace）',
    ...
    ja: {
      ...
      'pipeline.delete': '削除',
      'pipeline.delete_title': '選択ブロックを削除（Del/Backspace）',
    ...
    ko: {
      ...
      'pipeline.delete': '삭제',
      'pipeline.delete_title': '선택 블록 삭제(Del/Backspace)',
    ...
    vi: {
      ...
      'pipeline.delete': 'Xoa',
      'pipeline.delete_title': 'Xoa khoi da chon (Del/Backspace)',
    ...
    ar: {
      ...
      'pipeline.delete': 'حذف',
      'pipeline.delete_title': 'حذف الكتلة المحددة (Del/Backspace)',
    ...
    fr: {
      ...
      'pipeline.delete_title': 'Supprimer le bloc sélectionné (Suppr/Retour)',
    ...
    es: {
      ...
      'pipeline.delete_title': 'Eliminar el bloque seleccionado (Supr/Retroceso)',
    ...
    ru: {
      ...
      'pipeline.delete_title': 'Удалить выбранный блок (Del/Backspace)',
    ...
    de: {
      ...
      'pipeline.delete_title': 'Ausgewählten Block löschen (Entf/Backspace)',
