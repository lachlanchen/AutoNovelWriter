...
- Task definition JSON (notes + acceptance): references/autonovelwriter_dev/steps/T006_agent_settings_codex_stub/task.json

This step:
- Task ID: T006_agent_settings_codex_stub
- Task title: Agent settings + codex runner stub (no secrets committed)
- Stage: update_readme (strict)

Required workspace/output paths:
- Step working dir: references/autonovelwriter_dev/steps/T006_agent_settings_codex_stub/
- Write your outputs (notes/plan/debug/summary) into files under references/autonovelwriter_dev/steps/T006_agent_settings_codex_stub/:
  - plan: references/autonovelwriter_dev/steps/T006_agent_settings_codex_stub/plan.md
  - debug: references/autonovelwriter_dev/steps/T006_agent_settings_codex_stub/debug.md
  - summary: references/autonovelwriter_dev/steps/T006_agent_settings_codex_stub/summary.md
  - update_readme: update repo root README.md and note changes in references/autonovelwriter_dev/steps/T006_agent_settings_codex_stub/summary.md
...
- Append a short \"## README\" note to: references/autonovelwriter_dev/steps/T006_agent_settings_codex_stub/summary.md describing what you changed.
