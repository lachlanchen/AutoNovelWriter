...
- Task definition JSON (notes + acceptance): references/autonovelwriter_dev/steps/T008_blocks_indent_outdent_ui/task.json

This step:
- Task ID: T008_blocks_indent_outdent_ui
- Task title: Blocks UI: indent/outdent + nested render
- Stage: update_readme (strict)

Required workspace/output paths:
- Step working dir: references/autonovelwriter_dev/steps/T008_blocks_indent_outdent_ui/
- Write your outputs (notes/plan/debug/summary) into files under references/autonovelwriter_dev/steps/T008_blocks_indent_outdent_ui/:
  - plan: references/autonovelwriter_dev/steps/T008_blocks_indent_outdent_ui/plan.md
  - debug: references/autonovelwriter_dev/steps/T008_blocks_indent_outdent_ui/debug.md
  - summary: references/autonovelwriter_dev/steps/T008_blocks_indent_outdent_ui/summary.md
  - update_readme: update repo root README.md and note changes in references/autonovelwriter_dev/steps/T008_blocks_indent_outdent_ui/summary.md
...
- Append a short \"## README\" note to: references/autonovelwriter_dev/steps/T008_blocks_indent_outdent_ui/summary.md describing what you changed.
