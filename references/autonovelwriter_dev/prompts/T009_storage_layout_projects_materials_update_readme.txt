...
- Task definition JSON (notes + acceptance): references/autonovelwriter_dev/steps/T009_storage_layout_projects_materials/task.json

This step:
- Task ID: T009_storage_layout_projects_materials
- Task title: Storage layout: projects + materials index
- Stage: update_readme (strict)

Required workspace/output paths:
- Step working dir: references/autonovelwriter_dev/steps/T009_storage_layout_projects_materials/
- Write your outputs (notes/plan/debug/summary) into files under references/autonovelwriter_dev/steps/T009_storage_layout_projects_materials/:
  - plan: references/autonovelwriter_dev/steps/T009_storage_layout_projects_materials/plan.md
  - debug: references/autonovelwriter_dev/steps/T009_storage_layout_projects_materials/debug.md
  - summary: references/autonovelwriter_dev/steps/T009_storage_layout_projects_materials/summary.md
  - update_readme: update repo root README.md and note changes in references/autonovelwriter_dev/steps/T009_storage_layout_projects_materials/summary.md
...
- Append a short \"## README\" note to: references/autonovelwriter_dev/steps/T009_storage_layout_projects_materials/summary.md describing what you changed.
