...
- Task definition JSON (notes + acceptance): references/autonovelwriter_dev/steps/T010_novel_settings_separate_from_ui_lang/task.json

This step:
- Task ID: T010_novel_settings_separate_from_ui_lang
- Task title: Novel settings: language + UX options
- Stage: update_readme (strict)

Required workspace/output paths:
- Step working dir: references/autonovelwriter_dev/steps/T010_novel_settings_separate_from_ui_lang/
- Write your outputs (notes/plan/debug/summary) into files under references/autonovelwriter_dev/steps/T010_novel_settings_separate_from_ui_lang/:
  - plan: references/autonovelwriter_dev/steps/T010_novel_settings_separate_from_ui_lang/plan.md
  - debug: references/autonovelwriter_dev/steps/T010_novel_settings_separate_from_ui_lang/debug.md
  - summary: references/autonovelwriter_dev/steps/T010_novel_settings_separate_from_ui_lang/summary.md
  - update_readme: update repo root README.md and note changes in references/autonovelwriter_dev/steps/T010_novel_settings_separate_from_ui_lang/summary.md
...
- Append a short \"## README\" note to: references/autonovelwriter_dev/steps/T010_novel_settings_separate_from_ui_lang/summary.md describing what you changed.
