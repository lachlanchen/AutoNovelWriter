...
- Task definition JSON (notes + acceptance): references/autonovelwriter_dev/steps/T011_runner_writes_outputs_stub/task.json

This step:
- Task ID: T011_runner_writes_outputs_stub
- Task title: Runner: write drafts/revisions to outputs
- Stage: update_readme (strict)

Required workspace/output paths:
- Step working dir: references/autonovelwriter_dev/steps/T011_runner_writes_outputs_stub/
- Write your outputs (notes/plan/debug/summary) into files under references/autonovelwriter_dev/steps/T011_runner_writes_outputs_stub/:
  - plan: references/autonovelwriter_dev/steps/T011_runner_writes_outputs_stub/plan.md
  - debug: references/autonovelwriter_dev/steps/T011_runner_writes_outputs_stub/debug.md
  - summary: references/autonovelwriter_dev/steps/T011_runner_writes_outputs_stub/summary.md
  - update_readme: update repo root README.md and note changes in references/autonovelwriter_dev/steps/T011_runner_writes_outputs_stub/summary.md
...
- Append a short \"## README\" note to: references/autonovelwriter_dev/steps/T011_runner_writes_outputs_stub/summary.md describing what you changed.
