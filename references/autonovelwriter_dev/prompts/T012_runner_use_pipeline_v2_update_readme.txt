...
- Task definition JSON (notes + acceptance): references/autonovelwriter_dev/steps/T012_runner_use_pipeline_v2/task.json

This step:
- Task ID: T012_runner_use_pipeline_v2
- Task title: Runner: execute v2 pipeline script/AST
- Stage: update_readme (strict)

Required workspace/output paths:
- Step working dir: references/autonovelwriter_dev/steps/T012_runner_use_pipeline_v2/
- Write your outputs (notes/plan/debug/summary) into files under references/autonovelwriter_dev/steps/T012_runner_use_pipeline_v2/:
  - plan: references/autonovelwriter_dev/steps/T012_runner_use_pipeline_v2/plan.md
  - debug: references/autonovelwriter_dev/steps/T012_runner_use_pipeline_v2/debug.md
  - summary: references/autonovelwriter_dev/steps/T012_runner_use_pipeline_v2/summary.md
  - update_readme: update repo root README.md and note changes in references/autonovelwriter_dev/steps/T012_runner_use_pipeline_v2/summary.md
...
- Append a short \"## README\" note to: references/autonovelwriter_dev/steps/T012_runner_use_pipeline_v2/summary.md describing what you changed.
