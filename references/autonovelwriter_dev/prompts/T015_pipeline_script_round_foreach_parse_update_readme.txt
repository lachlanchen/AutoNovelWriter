...
- Task definition JSON (notes + acceptance): references/autonovelwriter_dev/steps/T015_pipeline_script_round_foreach_parse/task.json

This step:
- Task ID: T015_pipeline_script_round_foreach_parse
- Task title: Pipeline script: ROUND/FOREACH_TASK parse+render
- Stage: update_readme (strict)

Required workspace/output paths:
- Step working dir: references/autonovelwriter_dev/steps/T015_pipeline_script_round_foreach_parse/
- Write your outputs (notes/plan/debug/summary) into files under references/autonovelwriter_dev/steps/T015_pipeline_script_round_foreach_parse/:
  - plan: references/autonovelwriter_dev/steps/T015_pipeline_script_round_foreach_parse/plan.md
  - debug: references/autonovelwriter_dev/steps/T015_pipeline_script_round_foreach_parse/debug.md
  - summary: references/autonovelwriter_dev/steps/T015_pipeline_script_round_foreach_parse/summary.md
  - update_readme: update repo root README.md and note changes in references/autonovelwriter_dev/steps/T015_pipeline_script_round_foreach_parse/summary.md
...
- Append a short \"## README\" note to: references/autonovelwriter_dev/steps/T015_pipeline_script_round_foreach_parse/summary.md describing what you changed.
