...
- Task definition JSON (notes + acceptance): references/autonovelwriter_dev/steps/T016_pwa_loop_repeat_editor/task.json

This step:
- Task ID: T016_pwa_loop_repeat_editor
- Task title: Blocks UI: edit loop repeat counts
- Stage: update_readme (strict)

Required workspace/output paths:
- Step working dir: references/autonovelwriter_dev/steps/T016_pwa_loop_repeat_editor/
- Write your outputs (notes/plan/debug/summary) into files under references/autonovelwriter_dev/steps/T016_pwa_loop_repeat_editor/:
  - plan: references/autonovelwriter_dev/steps/T016_pwa_loop_repeat_editor/plan.md
  - debug: references/autonovelwriter_dev/steps/T016_pwa_loop_repeat_editor/debug.md
  - summary: references/autonovelwriter_dev/steps/T016_pwa_loop_repeat_editor/summary.md
  - update_readme: update repo root README.md and note changes in references/autonovelwriter_dev/steps/T016_pwa_loop_repeat_editor/summary.md
...
- Append a short \"## README\" note to: references/autonovelwriter_dev/steps/T016_pwa_loop_repeat_editor/summary.md describing what you changed.
