...
- Task definition JSON (notes + acceptance): references/autonovelwriter_dev/steps/T019_pwa_insert_container_blocks/task.json

This step:
- Task ID: T019_pwa_insert_container_blocks
- Task title: PWA: insert LOOP/ROUND/FOREACH_TASK blocks
- Stage: update_readme (strict)

Required workspace/output paths:
- Step working dir: references/autonovelwriter_dev/steps/T019_pwa_insert_container_blocks/
- Write your outputs (notes/plan/debug/summary) into files under references/autonovelwriter_dev/steps/T019_pwa_insert_container_blocks/:
  - plan: references/autonovelwriter_dev/steps/T019_pwa_insert_container_blocks/plan.md
  - debug: references/autonovelwriter_dev/steps/T019_pwa_insert_container_blocks/debug.md
  - summary: references/autonovelwriter_dev/steps/T019_pwa_insert_container_blocks/summary.md
  - update_readme: update repo root README.md and note changes in references/autonovelwriter_dev/steps/T019_pwa_insert_container_blocks/summary.md
...
- Append a short \"## README\" note to: references/autonovelwriter_dev/steps/T019_pwa_insert_container_blocks/summary.md describing what you changed.
