...
- Task definition JSON (notes + acceptance): references/autonovelwriter_dev/steps/T020_tasks_batches_index_and_pwa_panel/task.json

This step:
- Task ID: T020_tasks_batches_index_and_pwa_panel
- Task title: Task batches: index API + PWA panel
- Stage: update_readme (strict)

Required workspace/output paths:
- Step working dir: references/autonovelwriter_dev/steps/T020_tasks_batches_index_and_pwa_panel/
- Write your outputs (notes/plan/debug/summary) into files under references/autonovelwriter_dev/steps/T020_tasks_batches_index_and_pwa_panel/:
  - plan: references/autonovelwriter_dev/steps/T020_tasks_batches_index_and_pwa_panel/plan.md
  - debug: references/autonovelwriter_dev/steps/T020_tasks_batches_index_and_pwa_panel/debug.md
  - summary: references/autonovelwriter_dev/steps/T020_tasks_batches_index_and_pwa_panel/summary.md
  - update_readme: update repo root README.md and note changes in references/autonovelwriter_dev/steps/T020_tasks_batches_index_and_pwa_panel/summary.md
...
- Append a short \"## README\" note to: references/autonovelwriter_dev/steps/T020_tasks_batches_index_and_pwa_panel/summary.md describing what you changed.
