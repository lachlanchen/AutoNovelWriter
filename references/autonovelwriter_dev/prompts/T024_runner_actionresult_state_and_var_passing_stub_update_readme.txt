...
- Task definition JSON (notes + acceptance): references/autonovelwriter_dev/steps/T024_runner_actionresult_state_and_var_passing_stub/task.json

This step:
- Task ID: T024_runner_actionresult_state_and_var_passing_stub
- Task title: Runner: ActionResult state + explicit var passing (stub)
- Stage: update_readme (strict)

Required workspace/output paths:
- Step working dir: references/autonovelwriter_dev/steps/T024_runner_actionresult_state_and_var_passing_stub/
- Write your outputs (notes/plan/debug/summary) into files under references/autonovelwriter_dev/steps/T024_runner_actionresult_state_and_var_passing_stub/:
  - plan: references/autonovelwriter_dev/steps/T024_runner_actionresult_state_and_var_passing_stub/plan.md
  - debug: references/autonovelwriter_dev/steps/T024_runner_actionresult_state_and_var_passing_stub/debug.md
  - summary: references/autonovelwriter_dev/steps/T024_runner_actionresult_state_and_var_passing_stub/summary.md
  - update_readme: update repo root README.md and note changes in references/autonovelwriter_dev/steps/T024_runner_actionresult_state_and_var_passing_stub/summary.md
...
- Append a short \"## README\" note to: references/autonovelwriter_dev/steps/T024_runner_actionresult_state_and_var_passing_stub/summary.md describing what you changed.
