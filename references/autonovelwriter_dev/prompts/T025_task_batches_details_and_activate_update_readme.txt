...
- Task definition JSON (notes + acceptance): references/autonovelwriter_dev/steps/T025_task_batches_details_and_activate/task.json

This step:
- Task ID: T025_task_batches_details_and_activate
- Task title: Task batches: details API + activate batch
- Stage: update_readme (strict)

Required workspace/output paths:
- Step working dir: references/autonovelwriter_dev/steps/T025_task_batches_details_and_activate/
- Write your outputs (notes/plan/debug/summary) into files under references/autonovelwriter_dev/steps/T025_task_batches_details_and_activate/:
  - plan: references/autonovelwriter_dev/steps/T025_task_batches_details_and_activate/plan.md
  - debug: references/autonovelwriter_dev/steps/T025_task_batches_details_and_activate/debug.md
  - summary: references/autonovelwriter_dev/steps/T025_task_batches_details_and_activate/summary.md
  - update_readme: update repo root README.md and note changes in references/autonovelwriter_dev/steps/T025_task_batches_details_and_activate/summary.md
...
- Append a short \"## README\" note to: references/autonovelwriter_dev/steps/T025_task_batches_details_and_activate/summary.md describing what you changed.
