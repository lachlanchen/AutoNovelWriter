...
- Task definition JSON (notes + acceptance): references/autonovelwriter_dev/steps/T026_project_settings_novel_language_separate/task.json

This step:
- Task ID: T026_project_settings_novel_language_separate
- Task title: Project settings: novel language (separate from UI)
- Stage: update_readme (strict)

Required workspace/output paths:
- Step working dir: references/autonovelwriter_dev/steps/T026_project_settings_novel_language_separate/
- Write your outputs (notes/plan/debug/summary) into files under references/autonovelwriter_dev/steps/T026_project_settings_novel_language_separate/:
  - plan: references/autonovelwriter_dev/steps/T026_project_settings_novel_language_separate/plan.md
  - debug: references/autonovelwriter_dev/steps/T026_project_settings_novel_language_separate/debug.md
  - summary: references/autonovelwriter_dev/steps/T026_project_settings_novel_language_separate/summary.md
  - update_readme: update repo root README.md and note changes in references/autonovelwriter_dev/steps/T026_project_settings_novel_language_separate/summary.md
...
- Append a short \"## README\" note to: references/autonovelwriter_dev/steps/T026_project_settings_novel_language_separate/summary.md describing what you changed.
