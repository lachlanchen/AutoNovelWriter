...
- Task definition JSON (notes + acceptance): references/autonovelwriter_dev/steps/T027_pipeline_if_else_parse_render/task.json

This step:
- Task ID: T027_pipeline_if_else_parse_render
- Task title: Pipeline: IF/ELSE parse+render
- Stage: update_readme (strict)

Required workspace/output paths:
- Step working dir: references/autonovelwriter_dev/steps/T027_pipeline_if_else_parse_render/
- Write your outputs (notes/plan/debug/summary) into files under references/autonovelwriter_dev/steps/T027_pipeline_if_else_parse_render/:
  - plan: references/autonovelwriter_dev/steps/T027_pipeline_if_else_parse_render/plan.md
  - debug: references/autonovelwriter_dev/steps/T027_pipeline_if_else_parse_render/debug.md
  - summary: references/autonovelwriter_dev/steps/T027_pipeline_if_else_parse_render/summary.md
  - update_readme: update repo root README.md and note changes in references/autonovelwriter_dev/steps/T027_pipeline_if_else_parse_render/summary.md
...
- Append a short \"## README\" note to: references/autonovelwriter_dev/steps/T027_pipeline_if_else_parse_render/summary.md describing what you changed.
