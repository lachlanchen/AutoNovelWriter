...
- Task definition JSON (notes + acceptance): references/autonovelwriter_dev/steps/T028_pwa_insert_foreach_action_and_if_else/task.json

This step:
- Task ID: T028_pwa_insert_foreach_action_and_if_else
- Task title: PWA: insert FOREACH_ACTION + IF/ELSE blocks
- Stage: update_readme (strict)

Required workspace/output paths:
- Step working dir: references/autonovelwriter_dev/steps/T028_pwa_insert_foreach_action_and_if_else/
- Write your outputs (notes/plan/debug/summary) into files under references/autonovelwriter_dev/steps/T028_pwa_insert_foreach_action_and_if_else/:
  - plan: references/autonovelwriter_dev/steps/T028_pwa_insert_foreach_action_and_if_else/plan.md
  - debug: references/autonovelwriter_dev/steps/T028_pwa_insert_foreach_action_and_if_else/debug.md
  - summary: references/autonovelwriter_dev/steps/T028_pwa_insert_foreach_action_and_if_else/summary.md
  - update_readme: update repo root README.md and note changes in references/autonovelwriter_dev/steps/T028_pwa_insert_foreach_action_and_if_else/summary.md
...
- Append a short \"## README\" note to: references/autonovelwriter_dev/steps/T028_pwa_insert_foreach_action_and_if_else/summary.md describing what you changed.
