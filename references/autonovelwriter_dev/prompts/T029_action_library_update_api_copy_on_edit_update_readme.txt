...
- Task definition JSON (notes + acceptance): references/autonovelwriter_dev/steps/T029_action_library_update_api_copy_on_edit/task.json

This step:
- Task ID: T029_action_library_update_api_copy_on_edit
- Task title: Action Library: update API (copy-on-edit)
- Stage: update_readme (strict)

Required workspace/output paths:
- Step working dir: references/autonovelwriter_dev/steps/T029_action_library_update_api_copy_on_edit/
- Write your outputs (notes/plan/debug/summary) into files under references/autonovelwriter_dev/steps/T029_action_library_update_api_copy_on_edit/:
  - plan: references/autonovelwriter_dev/steps/T029_action_library_update_api_copy_on_edit/plan.md
  - debug: references/autonovelwriter_dev/steps/T029_action_library_update_api_copy_on_edit/debug.md
  - summary: references/autonovelwriter_dev/steps/T029_action_library_update_api_copy_on_edit/summary.md
  - update_readme: update repo root README.md and note changes in references/autonovelwriter_dev/steps/T029_action_library_update_api_copy_on_edit/summary.md
...
- Append a short \"## README\" note to: references/autonovelwriter_dev/steps/T029_action_library_update_api_copy_on_edit/summary.md describing what you changed.
