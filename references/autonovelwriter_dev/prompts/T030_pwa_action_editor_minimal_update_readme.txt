...
- Task definition JSON (notes + acceptance): references/autonovelwriter_dev/steps/T030_pwa_action_editor_minimal/task.json

This step:
- Task ID: T030_pwa_action_editor_minimal
- Task title: PWA: Action Editor (prompt/script/tool)
- Stage: update_readme (strict)

Required workspace/output paths:
- Step working dir: references/autonovelwriter_dev/steps/T030_pwa_action_editor_minimal/
- Write your outputs (notes/plan/debug/summary) into files under references/autonovelwriter_dev/steps/T030_pwa_action_editor_minimal/:
  - plan: references/autonovelwriter_dev/steps/T030_pwa_action_editor_minimal/plan.md
  - debug: references/autonovelwriter_dev/steps/T030_pwa_action_editor_minimal/debug.md
  - summary: references/autonovelwriter_dev/steps/T030_pwa_action_editor_minimal/summary.md
  - update_readme: update repo root README.md and note changes in references/autonovelwriter_dev/steps/T030_pwa_action_editor_minimal/summary.md
...
- Append a short \"## README\" note to: references/autonovelwriter_dev/steps/T030_pwa_action_editor_minimal/summary.md describing what you changed.
