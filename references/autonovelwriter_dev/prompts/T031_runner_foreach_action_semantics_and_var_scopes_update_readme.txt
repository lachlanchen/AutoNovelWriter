...
- Task definition JSON (notes + acceptance): references/autonovelwriter_dev/steps/T031_runner_foreach_action_semantics_and_var_scopes/task.json

This step:
- Task ID: T031_runner_foreach_action_semantics_and_var_scopes
- Task title: Runner: FOREACH_ACTION semantics + var scopes
- Stage: update_readme (strict)

Required workspace/output paths:
- Step working dir: references/autonovelwriter_dev/steps/T031_runner_foreach_action_semantics_and_var_scopes/
- Write your outputs (notes/plan/debug/summary) into files under references/autonovelwriter_dev/steps/T031_runner_foreach_action_semantics_and_var_scopes/:
  - plan: references/autonovelwriter_dev/steps/T031_runner_foreach_action_semantics_and_var_scopes/plan.md
  - debug: references/autonovelwriter_dev/steps/T031_runner_foreach_action_semantics_and_var_scopes/debug.md
  - summary: references/autonovelwriter_dev/steps/T031_runner_foreach_action_semantics_and_var_scopes/summary.md
  - update_readme: update repo root README.md and note changes in references/autonovelwriter_dev/steps/T031_runner_foreach_action_semantics_and_var_scopes/summary.md
...
- Append a short \"## README\" note to: references/autonovelwriter_dev/steps/T031_runner_foreach_action_semantics_and_var_scopes/summary.md describing what you changed.
