...
- Task definition JSON (notes + acceptance): references/autonovelwriter_dev/steps/T032_project_settings_extend_novel_overrides/task.json

This step:
- Task ID: T032_project_settings_extend_novel_overrides
- Task title: Project settings: extend novel overrides (inherit)
- Stage: update_readme (strict)

Required workspace/output paths:
- Step working dir: references/autonovelwriter_dev/steps/T032_project_settings_extend_novel_overrides/
- Write your outputs (notes/plan/debug/summary) into files under references/autonovelwriter_dev/steps/T032_project_settings_extend_novel_overrides/:
  - plan: references/autonovelwriter_dev/steps/T032_project_settings_extend_novel_overrides/plan.md
  - debug: references/autonovelwriter_dev/steps/T032_project_settings_extend_novel_overrides/debug.md
  - summary: references/autonovelwriter_dev/steps/T032_project_settings_extend_novel_overrides/summary.md
  - update_readme: update repo root README.md and note changes in references/autonovelwriter_dev/steps/T032_project_settings_extend_novel_overrides/summary.md
...
- Append a short \"## README\" note to: references/autonovelwriter_dev/steps/T032_project_settings_extend_novel_overrides/summary.md describing what you changed.
